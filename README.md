...
3. **Окно урока**: открывается при нажатии на урок. Содержит название урока, текст урока и кнопку для завершения урока. В тексте урока могут быть теги для изображений, такие как `[img:image_name]`, которые заменяются на соответствующие изображения из ресурсов приложения с помощью метода `addTextContent`.<br>
   <img src="https://github.com/Delloon/Developer-in-my-pocket/blob/main/images/1.jpg" alt="Главное окно" width="10%">
   <img src="https://github.com/Delloon/Developer-in-my-pocket/blob/main/images/2.jpg" alt="Окно с темами курса" width="10%">
   <img src="https://github.com/Delloon/Developer-in-my-pocket/blob/main/images/3.jpg" alt="Окно урока" width="10%">
