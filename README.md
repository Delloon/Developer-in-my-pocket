...
1. Скачайте приложение со [страницы релизов](https://github.com/Delloon/Developer-in-my-pocket/releases).
2. Запустите приложение на устройстве.
3. Войдите в систему или зарегистрируйтесь.
4. Просматривайте доступные курсы и выбирайте нужный для изучения.
5. Следуйте урокам курса, отвечайте на контрольные вопросы и отслеживайте свой прогресс.
